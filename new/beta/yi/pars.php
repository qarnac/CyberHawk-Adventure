<?php
	...
	$keyword=$_GET["q"];
    // set feed URL
    $feedURL = 'https://gdata.youtube.com/feeds/api/videos?q='.$keyword.'&orderby=viewCount&max-results=10';
		...
		else
		{
			if($count==2)
			{
               ...
               <li>  
                ...
                <img src="<?php echo $thumbnail;?>" height="140" width="160" onClick="replace1('<?php echo $vc; ?>')"/>
	...
	echo "</ul>		</div>";
		?>	
      <div id="content">
          <a href="<?php echo $w1; ?>"><?php echo $t1; ?></a>
        
        
<?php echo "<iframe id='disp' width='560' height='345' src='http://www.youtube.com/embed/".$vc1."?autoplay=1' frameborder='0' allowfullscreen></iframe>"; ?>
        <? ?>
