...
if(isset($_POST['content'])&&<isset($_SESSION['login'])==true && $_SESSION['who']=='students'){
	include 'user_upload.php';
	// I'm adding this line so I can know when the wrong upload file was called within the source code.
	//Once all incorrect upload files are fixed, this entire if statement can be removed.
