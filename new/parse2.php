  ...
  <meta property='og:video' content='http://www.youtube.com/v/$vc1[0]?autoplay=1&version=3&amp;autohide=1'>
...
<option value='rating' >Rating</option>
	...
	for($i=0;$i<$count;$i++)
		...
		if($i==0)
			...
			<iframe id='disp' width='770' height='440' src='http://www.youtube.com/embed/".$vc1[$i]."?autoplay=1&wmode=opaque' frameborder='10' allowfullscreen></iframe>
...
<h3 id='reltitle'>&nbsp;&nbsp;&nbsp;&nbsp; Related</h3></font></div>";
		...
		echo "</ul> Share It    <div id='share'  > <img src='/images/fb.png' onclick='fshare(this.name)' name='$vid' ></div>&nbsp; Share Url<input type='text' id='shareurl' size='40' value='http://seedspirit.com/?id=$vid' /></div>";
	}
